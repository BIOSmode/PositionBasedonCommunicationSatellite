...
"QTabBar::tab:selected{background:blue}"));
        ...
        HomDiscripetion->setGeometry(QRect(250, 300, 571, 41));
        HomMainTitle = new QLabel(Home);
        HomMainTitle->setObjectName(QStringLiteral("HomMainTitle"));
        HomMainTitle->setGeometry(QRect(340, 400, 441, 231));
        HomeInfor = new QLabel(Home);
        HomeInfor->setObjectName(QStringLiteral("HomeInfor"));
        HomeInfor->setGeometry(QRect(100, 160, 881, 71));
        HomeInfor->setStyleSheet(QStringLiteral("font: 32pt \"Times New Roman\";"));
